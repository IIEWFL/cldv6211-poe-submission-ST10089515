...
namespace THERIDEYOURENT_.Controllers
{
    public class InspectorController : Controller
    {
        ...
        public InspectorController(TheRideYouRentPoe3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Inspectors != null ? 
                          ...
                          Problem("Entity set 'TheRideYouRentPoe3Context.Inspectors'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TheRideYouRentPoe3Context.Inspectors'  is null.");
            }
            var inspector = await _context.Inspectors.FindAsync(id);
            if (inspector != null)
            {
